        ...
        <div class="page-content">
            <div class="form-section">
                <div class="form-header">
                    ...
                    <h3>Crear Nueva Confirmación</h3>
                    <p>Complete el formulario para registrar una nueva confirmación</p>
                </div>

                <div class="form-body">
                    <form action="{{ route('confirmaciones.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="section-card">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <label for="fecha_confirmacion" class="form-label required-field">Fecha de
                                        Confirmación:</label>
                                    <div class="input-icon">
                                        <i class="lni lni-calendar"></i>
                                        <input type="date" class="form-control" id="fecha_confirmacion"
                                            name="fecha_confirmacion" value="{{ old('fecha_confirmacion') }}">
                                    </div>
                        ...
                        <div class="section-card">
                            <div class="section-title">
                                <i class="lni lni-crown"></i> Información del Sacerdote
                            </div>

                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <label for="sacerdote_search" class="form-label required-field">Sacerdote (Monseñor o
                                        Delegado):</label>
                        ...
                        <div class="section-card">
                            <div class="section-title">
                                <i class="lni lni-user"></i> Persona Confirmada
                            </div>

                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <label for="persona_confirmada_search" class="form-label required-field">Buscar
                                        Persona:</label>
                                    <div class="search-container">
                                        <div class="input-icon">
                                            <i class="lni lni-search"></i>
                                        ...
                                        <div class="search-results">
                                            <select id="select_persona_confirmada" class="form-control"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <label for="nombre_parroquia_bautizo" class="form-label">Bautizada/o en la
                                        Parroquia:</label>
                                    <div class="input-icon">
                                        <i class="lni lni-church"></i>
                                        <input type="text" class="form-control" id="nombre_parroquia_bautizo"
                                            name="nombre_parroquia_bautizo" value="{{ old('nombre_parroquia_bautizo') }}"
                                            placeholder="Nombre de la parroquia donde se bautizó">
                                    </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="submit-button">
                                <i class="lni lni-save"></i> Guardar Confirmación
                            </button>
                        </div>
                    </form>
                </div>
...
@section('script')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            setupPersonSearch('persona_confirmada_search', 'persona_confirmada_id', 'select_persona_confirmada', 'F');
            ...
            function cargarPersonasSeleccionadas() {
                const personaIds = {
                    'persona_confirmada_id': 'persona_confirmada_search',
