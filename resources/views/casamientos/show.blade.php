                ...
                <div class="info-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $casamiento->padreEsposo->nombres }}
                                {{ $casamiento->padreEsposo->apellidos }}</div>

                        </div>
                        <div class="info-item">
                            <span class="info-label">Madre:</span>
                            <div class="info-value">{{ $casamiento->madreEsposo->nombres }}
                                {{ $casamiento->madreEsposo->apellidos }}</div>
