...
return [
    ...
    */
    ...
    'options' => [
        ...
        'font_dir' => public_path('assets/fonts'), // Directorio donde Dompdf buscará y almacenará las métricas de las fuentes
        'font_cache' => public_path('assets/fonts'), // Directorio para el caché de fuentes
